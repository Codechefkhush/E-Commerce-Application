...
private void createHeaderBar(){
         ...
         Image image = new Image("C:\\Users\\HP\\IdeaProjects\\E-Commerce\\src\\ecommerce.png") ;
    ...
    homeButton.setGraphic(imageView);
        ...
        signInButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                body.getChildren().add(loginPage); //put loding page
...
Button addToCartButton = new Button("Add To Cart") ;
        ...
        buyNowButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                if (product==null){
                    showDialog ("Plaese select a product first to place order!") ;
                    return;
                }
                if (loggedInCustomer == null) {
                    showDialog("Please login first to place order!");
        ...
        addToCartButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                showDialog("Selected item(s) has been successfully added to cart!");
            }
        });
     }
